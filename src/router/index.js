...
import { isUrl, openLink, cloneDeep, storageLocal, isAllEmpty } from "@pureadmin/utils";
...
import { userKey, removeToken, multipleTabsKey } from "@bit-labs.cn/owl-ui/utils/auth";
/** 自动导入框架核心静态路由 */
...
export const constantRoutes = formatTwoStageRoutes(formatFlatteningRoutes(ascending(coreRoutes.flat(Infinity))));
/** 用于渲染菜单，保持原始层级 */
export const constantMenus = ascending(coreRoutes.flat(Infinity)).concat(...remainingRouter);
/** 不参与菜单的路由 */
